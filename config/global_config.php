...
/***************************************
  ...
  ***************************************/
  ...
  #define('_SESSION_PATH_', _ADMIN_PATH_ . 'ses_9c19848fb2747e278872f3f3e671c54f' . $path_separator);
  ...
  //------------------------------------------------------------------------
  $time_zone_locale = 'Asia/Shanghai'; // a full list can be found at http://uk.php.net/manual/en/timezones.php
  $dbh    = '127.0.0.1';  # dev remote server location
  $dbPort = '3306';    # dev database name/prefix
  $dbn    = 'program';    # dev database name/prefix
  $dbu    = 'myuser';       # dev database username
  $dbp    = '123456';  # dev database password
  ...
  $remember_up_to = 10;
  $debugemail = 'happyjoblzp@126.com';
